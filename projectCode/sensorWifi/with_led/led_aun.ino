...
/////////////////์NOEY
byte blank[3] = {0x00000000, 0x00000000, 0x00000000};
byte fill[3] = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF};

bool alertState = false; // สถานะปัจจุบันของการแสดงผล//

// ฟังก์ชันสำหรับอัพเดตการแสดงผลบน LED matrix
void updateDisplay() {
  // กำหนดค่าให้กับ image ตามสถานะ
  while (alertState){
    matrix.loadFrame(fill);
    delay(250);
